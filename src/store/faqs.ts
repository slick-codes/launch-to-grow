...
export const faqs = [
    {
        ...
        body: "Beyond our venture capital and consulting services, SPV management, finance consulting, and management consulting, we will happily refer founders to industry experts and partner organisations in our network who can provide them with the following services and more while fitting their budget: <br> <ul class='faq__list-container'><li>Legal Services</li><li>Digital Marketing</li><li>Web & App Development</li></ul>"
    }
]